...
class EmployeeIterator {
  ...
  // Робимо метод next, який повертає наступного працівника в масиві
  //та збільшує #currentIndex на 1 якщо є наступний елемент, інакше повертає null.
  next() {
    if (this.#hasNext()) {
  ...
  list() {
    return employeeGroup.employees.map((user) => user.name).join(", ");
  }
}
