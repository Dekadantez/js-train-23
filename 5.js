...
class TransferAdapter {
  ...
  constructor(transferSystem) {
    this.transferSystem = new WalletTransfer(transferSystem);
  }
  ...
  // Викликаємо допоміжний метод calculateFee для обчислення комісії за переказ та результат записуєм
  // в константу calculatedAmount
  ...
  processTransfer = WalletTransfer(calculatedAmount);
